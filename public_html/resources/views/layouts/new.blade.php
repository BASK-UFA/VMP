                        ...
                        <div class="collapse navbar-collapse sub-menu-bar" id="navbarSupportedContent">
                            <ul id="nav" class="navbar-nav ml-auto">
                                <li class="nav-item active">
                                    <a class="page-scroll" href="{{ route('/') }}">Главная</a>
                                </li>
                                <li class="nav-item">
                                    <a class="page-scroll" href="{{ route('posts.index') }}">Блог</a>
                                </li>
                                <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    <a class="page-scroll" href="{{ route('products.index') }}">Наши работы</a>
                                </li>
                                <li class="nav-item">
                                    <a class="page-scroll" href="{{ route('education.programs.index') }}">Обучение</a>
                                </li>
                            </ul>
                        </div> <!-- navbar collapse -->
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="about-content mt-50 wow fadeInLeftBig" data-wow-duration="1s" data-wow-delay="0.5s">
                    ...
                    <a href="#" class="main-btn">Присоединиться</a>
                </div> <!-- about content -->
            </div>
            <div class="col-lg-6">
        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="section-title pb-35">
                    <div class="line"></div>
                    <h3 class="title"><span>Последние Сообщения</span> В Блоге</h3>
                </div> <!-- section title -->
            </div>
        </div> <!-- row -->
        <div class="row justify-content-center">
            ...
            <div class="row">
                <div class="col-lg-5 col-md-6 col-sm-8">
                    <div class="footer-about mt-50 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s">
                        <a class="logo" href="#">
                            <b style="color: #ffffff; font-size: 2rem !important;">ВМП</b>
                        </a>
                    ...
                    <div class="footer-link d-flex mt-50 justify-content-md-between">
                        <div class="link-wrapper wow fadeIn" data-wow-duration="1s" data-wow-delay="0.6s">
                            ...
                            <ul class="link">
                                ...
                                <li><a href="{{ route('products.index') }}">Наши работы</a></li>
                                <li><a href="{{ route('education.programs.index') }}">Обучение</a></li>
                            </ul>
                        </div> <!-- footer wrapper -->
                    </div> <!-- footer link -->
                </div>
