        ...
        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel"
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="d-block w-100" src="{{ asset('images/back.png') }}" alt="First slide">
                    <div style="top: 50%" class="carousel-caption d-none d-md-block pt-0 pb-0">
                        <h1 class="post_name">Виртуальная мастерская программистов</h1>
                    </div>
                </div>
                <div class="carousel-item">
                    <img class="d-block w-100" src="{{ asset('images/back2.jpg') }}" alt="Second slide">
                </div>
                <div class="carousel-item">
                    <img class="d-block w-100" src="{{ asset('images/back2.jpg') }}" alt="Third slide">
                </div>
            </div>
