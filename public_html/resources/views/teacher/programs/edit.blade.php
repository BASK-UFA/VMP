...
@section('content')
    @php /** var @var \App\Models\EducationProgram $item */ @endphp
    ...
    @if($item->exists)
        <form enctype="multipart/form-data" method="POST" action="{{ route('teacher.programs.update', $item->id) }}">
            @method('PATCH')
            @else
                <form enctype="multipart/form-data" method="POST" action="{{ route('teacher.programs.store') }}">
                    @endif
                    <div class="container">
                        @csrf
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-footer border-0">
                                                <div class="form-group">
                                                    <label for="title" class="h5">Название программы</label>
                                                ...
                                                <div class="form-group">
                                                    <label for="content_raw" class="h5">Изображение</label>
                        ...
                        <div class="row">
                            <div class="col-md-9">
                                <div class="card p-2">
                                    ...
                                    <form method="POST" action="{{ route('teacher.programs.destroy', $item->id) }}">
                                        @method('DELETE')
                                        @csrf
                                        <div class="row justify-content-center">
                                            <div class="col-md-12 ">
