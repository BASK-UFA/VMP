...
@section('content')
    ...
    <div class="web__header">
        <h1 class="text-center">Сетевое и системное администрирование</h1>
    </div>
            ...
            <div class="row">
                <div class="col-md-8" style="border-right: 1px solid #d3d2d2;">
                    <p style="font-size: 1.8rem; font-weight: bold">
                        Сетевой и системный администратор предоставляет услуги в области информационных технологий для
                        предприятий и организаций в коммерческом и государственном секторах. Главная задача этого
                        специалиста — обеспечение непрерывной и бесперебойной работы сетей и систем.
                    </p>
                    <p>
                        Эта профессия предполагает выполнение различных задач: поддержку пользователей, проектирование,
                        поиск и устранение неисправностей, монтаж, настройку конфигураций и обновление операционных
