                ...
                <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <label for="created_at" class="h5 Oswald">Создано</label>
                                <input id="created_at" type="text" value="{{ $item->created_at }}" class="form-control"
                                       disabled>
                            </div>
                            <div class="form-group">
                                <label for="updated_at"class="h5 Oswald">Изменено</label>
                                <input id="updated_at" type="text" value="{{ $item->updated_at }}" class="form-control"
                                       disabled>
                            </div>
                            <div class="form-group">
                                <label for="deleted_at"class="h5 Oswald">Удалено</label>
